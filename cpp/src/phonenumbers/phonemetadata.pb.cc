  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 6: {
        ...
        if (input->ExpectTag(72)) goto parse_possible_length;
        break;
      }
      ...
      case 9: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
         parse_possible_length:
          DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitive<
                   ::google::protobuf::int32, ::google::protobuf::internal::WireFormatLite::TYPE_INT32>(
                 1, 72, input, this->mutable_possible_length())));
        ...
        if (input->ExpectTag(72)) goto parse_possible_length;
        if (input->ExpectTag(80)) goto parse_possible_length_local_only;
        break;
      }
      ...
      case 10: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
         parse_possible_length_local_only:
          DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitive<
                   ::google::protobuf::int32, ::google::protobuf::internal::WireFormatLite::TYPE_INT32>(
                 1, 80, input, this->mutable_possible_length_local_only())));
        } else if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag)
                   == ::google::protobuf::internal::WireFormatLite::
                      WIRETYPE_LENGTH_DELIMITED) {
          DO_((::google::protobuf::internal::WireFormatLite::ReadPackedPrimitiveNoInline<
...
void PhoneNumberDesc::SerializeWithCachedSizes(
  ...
  // repeated int32 possible_length = 9;
  for (int i = 0; i < this->possible_length_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(
      9, this->possible_length(i), output);
  }

  // repeated int32 possible_length_local_only = 10;
  for (int i = 0; i < this->possible_length_local_only_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(
...
int PhoneNumberDesc::ByteSize() const {
  ...
  // repeated int32 possible_length = 9;
  {
    ...
    for (int i = 0; i < this->possible_length_size(); i++) {
      data_size += ::google::protobuf::internal::WireFormatLite::
        Int32Size(this->possible_length(i));
    }
    total_size += 1 * this->possible_length_size() + data_size;
  }
  ...
  // repeated int32 possible_length_local_only = 10;
  {
    ...
    for (int i = 0; i < this->possible_length_local_only_size(); i++) {
      data_size += ::google::protobuf::internal::WireFormatLite::
        Int32Size(this->possible_length_local_only(i));
    }
    total_size += 1 * this->possible_length_local_only_size() + data_size;
  }
...
void PhoneNumberDesc::Swap(PhoneNumberDesc* other) {
  if (other != this) {
    ...
    possible_length_.Swap(&other->possible_length_);
    possible_length_local_only_.Swap(&other->possible_length_local_only_);
...
#endif
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  sms_services_ = const_cast< ::i18n::phonenumbers::PhoneNumberDesc*>(
      ::i18n::phonenumbers::PhoneNumberDesc::internal_default_instance());
#else
  sms_services_ = const_cast< ::i18n::phonenumbers::PhoneNumberDesc*>(&::i18n::phonenumbers::PhoneNumberDesc::default_instance());
#endif
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 32: {
        ...
        if (input->ExpectTag(266)) goto parse_sms_services;
        break;
      }
...
void PhoneMetadata::Swap(PhoneMetadata* other) {
  if (other != this) {
    ...
    std::swap(sms_services_, other->sms_services_);
