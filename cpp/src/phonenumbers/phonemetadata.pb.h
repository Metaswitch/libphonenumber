...
class PhoneNumberDesc : public ::google::protobuf::MessageLite {
 public:
  ...
  inline int possible_length_size() const;
  inline void clear_possible_length();
  static const int kPossibleLengthFieldNumber = 9;
  inline ::google::protobuf::int32 possible_length(int index) const;
  inline void set_possible_length(int index, ::google::protobuf::int32 value);
  inline void add_possible_length(::google::protobuf::int32 value);
  ...
  inline int possible_length_local_only_size() const;
  inline void clear_possible_length_local_only();
  static const int kPossibleLengthLocalOnlyFieldNumber = 10;
  inline ::google::protobuf::int32 possible_length_local_only(int index) const;
  inline void set_possible_length_local_only(int index, ::google::protobuf::int32 value);
  inline void add_possible_length_local_only(::google::protobuf::int32 value);
  inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
...
class PhoneMetadata : public ::google::protobuf::MessageLite {
 public:
  ...
  inline bool has_sms_services() const;
  inline void clear_sms_services();
  static const int kSmsServicesFieldNumber = 33;
  inline const ::i18n::phonenumbers::PhoneNumberDesc& sms_services() const;
  inline ::i18n::phonenumbers::PhoneNumberDesc* mutable_sms_services();
  inline ::i18n::phonenumbers::PhoneNumberDesc* release_sms_services();
  inline void set_allocated_sms_services(::i18n::phonenumbers::PhoneNumberDesc* sms_services);
 ...
 private:
  ...
  inline void set_has_sms_services();
  inline void clear_has_sms_services();
...
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  return sms_services_ != NULL ? *sms_services_ : *default_instance().sms_services_;
#else
  return sms_services_ != NULL ? *sms_services_ : *default_instance_->sms_services_;
#endif
}
inline ::i18n::phonenumbers::PhoneNumberDesc* PhoneMetadata::mutable_sms_services() {
  set_has_sms_services();
  if (sms_services_ == NULL) sms_services_ = new ::i18n::phonenumbers::PhoneNumberDesc;
